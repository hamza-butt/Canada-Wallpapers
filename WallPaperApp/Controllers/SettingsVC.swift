...
class SettingsVC: UIViewController {
    ...
    @IBOutlet weak var termOfServiceView: UIView!
    ...
    override func viewDidLoad() {
        ...
        self.termOfServiceView.layer.cornerRadius = 5.0
    ...
    @IBAction func termOfServiceTapped(_ sender: Any) {
        guard let url = URL(string: term_Of_Service) else { return }
        UIApplication.shared.open(url)
    }
