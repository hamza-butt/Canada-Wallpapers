...
open class BubbleTabBar: UITabBar {
    ...
    private func configure() {
        backgroundColor = #colorLiteral(red: 0.6666666667, green: 0.06666666667, blue: 0.01568627451, alpha: 1)
        isTranslucent = false
        barTintColor = UIColor.white  
        tintColor = #colorLiteral(red: 0.1764705882, green: 0.2431372549, blue: 0.3490196078, alpha: 1)
